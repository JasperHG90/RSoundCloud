...
Filters can also be used for e.g. tracks.
...
```{r}
# Filter for tracks created after 22 May 2015
us <- SCapi_specific(clientID$clientID, "https://soundcloud.com/the-bugle/likes", type="url", 
                     query_type="users", get="tracks", filter=list("created_at[from]" = "2015-05-20"))
```

As of yet, it is not possible to do specific searches via soundcloud ID. This will be implemented sometime this week.
