...
I created this package because it seemed like a fun project. If you decide to use it, please **read** and **adhere** to the [SoundCloud API terms of use](https://developers.soundcloud.com/docs/api/terms-of-use). 

The end-user of the RSoundCloud package is, at all times, liable for his/her actions while using it.
